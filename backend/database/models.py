...
class User(Base):
    ...
    account_status: Mapped[str] = mapped_column(String(32), nullable=False, default="active", index=True)
    must_change_password: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False)
    terms_version_accepted: Mapped[str] = mapped_column(String(32), nullable=False, default="")
    privacy_version_accepted: Mapped[str] = mapped_column(String(32), nullable=False, default="")
    beta_notice_version_accepted: Mapped[str] = mapped_column(String(32), nullable=False, default="")
...
class AuctionItem(Base):
    ...
    public_category: Mapped[str] = mapped_column(String(32), nullable=False, default="other", index=True)
    freshness_date: Mapped[str] = mapped_column(String(10), nullable=False, default="", index=True)
    freshness_status: Mapped[str] = mapped_column(String(32), nullable=False, default="unknown_date", index=True)
    public_visible: Mapped[bool] = mapped_column(Boolean, nullable=False, default=False, index=True)
